...
const routes = [
  ...
  { path: '/admin/painel',           component: () => import('../views/admin/PainelView.vue'),              meta: { auth: true, admin: true } },
  { path: '/admin/mensagens',        component: () => import('../views/admin/MensagensView.vue'),           meta: { auth: true, admin: true } },
